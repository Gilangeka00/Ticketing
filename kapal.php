...
// Membangun query
$sql    = 'SELECT * FROM tickets WHERE type = "kapal" AND origin LIKE ? AND destination LIKE ?';
...
<div class="container mx-auto mt-10">
  <h2 class="text-2xl font-bold mb-4">Hasil Pencarian Kapal</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <?php foreach ($flights as $flight): ?>
        <div class="bg-white rounded shadow p-4">
          ...
          <a href="pemesanan_kapal.php?id=<?= $flight['id'] ?>" 
